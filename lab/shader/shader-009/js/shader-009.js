...
(function(){
    ...
    once($(".crt-stage"), ()=>{
      ...
      LINES.forEach((L,i)=>{
        ...
        d.innerHTML = '<span class="dim"></span><span></span>';
        scr.appendChild(d);
        if (reduce){ d.children[0].textContent = L[0]; d.children[1].textContent = L[1]; return; }
        setTimeout(()=>{
          type(d.children[0], L[0], ()=> type(d.children[1], L[1]));
        }, i*430);
      });
    });
