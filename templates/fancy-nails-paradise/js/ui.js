/* Fancy Nails Paradise — shared chrome: reveals, mobile nav drawer, open-now clock.

   Salon hours are a single published fact — 10am to 8pm, every day — so the
   clock here is deliberately simple. It exists because "are they open right
   now" is the question a phone visitor actually has. */
(function () {
  "use strict";
  ...
  window.FNP_UI = { rescanReveals: rescanReveals, toast: toast, serviceState: state };
})();
