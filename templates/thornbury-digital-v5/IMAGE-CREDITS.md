...
Type over the liquid field. No photograph, no film, no object: nothing on
the first screen is sourced from anyone. The Earth that stood here for one
build — NASA's Blue Marble and Black Marble, packed into one texture — is
retired and no longer in the repository.
